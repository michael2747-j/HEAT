/*
GEN_REALTIME_CSV.cs
Combines network capture, data aggregation, and CSV export for real-time network interface analysis.
Created: June 5, 2025
...
namespace HEAT
{
    ...
    public static class DataModels
    {
        ...
        public static readonly HashSet<int> ipProtocols = new() { 50, 51, 89 };
